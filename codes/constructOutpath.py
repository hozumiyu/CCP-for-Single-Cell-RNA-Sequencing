...
def constructNMFpath(data):
    outpath = './features/%s_features/%s_nmf_features/'%(data, data); makeFolder(outpath)
    return outpath

def constructNMFpathResults(data):
    outpath = './raw_results/%s_rawResults/%s_nmf_rawResults_clustering/'%(data, data); makeFolder(outpath)
    return outpath

def constructNMFpathResultsClassification(data):
    outpath = './raw_results/%s_rawResults/%s_nmf_rawResults_classification/'%(data, data); makeFolder(outpath)
    return outpath

def constructNMFpathResultsRSI(data):
    outpath = './raw_results/%s_rawResults/%s_nmf_rawResults_rsi/'%(data, data); makeFolder(outpath)
    return outpath