...
data, method, scaling, cutoff, n_components = 'GSE67835' , 'tsne', 'std' ,'0.7','300'
...
data, method, scaling, cutoff, n_components = 'GSE82187' , 'tsne', 'raw' ,'0.7','150'
...
data, method, scaling, cutoff, n_components = 'GSE84133human4' , 'tsne', 'raw' ,'0.6','150'
...
data, method, scaling, cutoff, n_components = 'GSE84133mouse1' , 'tsne', 'raw' ,'0.8','250'
...
fig.savefig(outpath + 'results2_new.png', bbox_inches='tight', dpi = 500)
'''
data_vec = []
