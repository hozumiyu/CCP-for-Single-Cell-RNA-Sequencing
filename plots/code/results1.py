...
data_vec = []
data_vec.append( ['GSE67835', 'raw',0.7,300])
data_vec.append( ['GSE82187', 150])

data_vec.append( ['GSE84133human4', 200])
data_vec.append( ['GSE84133mouse1', 150])
...
###########################################################################
#GSE75748cell
data, method, scaling, cutoff, n_components = 'GSE75748cell' , 'umap', 'raw' ,'0.7','250'
row = 0
y = load_y(data)
...
inpath = '../CCP_secondary_cutoff_main_v2/plotting_features/%s_features/'%( data)
file = '%s_c%s_n%s_s1_%s_%s.npy'%(data, cutoff, n_components, method, scaling)
...
data, method, scaling, cutoff, n_components = 'GSE75748cell' , 'tsne', 'raw' ,'0.7','250'
...
###########################################################################
#GSE75748time
data, method, scaling, cutoff, n_components = 'GSE75748time' , 'umap', 'std' ,'0.7','300'
row = 1
y = load_y(data)
...
data, method, scaling, cutoff, n_components = 'GSE75748time' , 'tsne', 'std' ,'0.7','300'
...
#GSE57249
data, method, scaling, cutoff, n_components = 'GSE57249' , 'umap', 'std' ,'0.7','50'
row = 2
...
data, method, scaling, cutoff, n_components = 'GSE57249' , 'tsne', 'std' ,'0.7','50'
...
###########################################################################
#GSE94820
data, method, scaling, cutoff, n_components = 'GSE94820' , 'umap', 'std' ,'0.5','250'
row = 3
y = load_y(data)
...
data, method, scaling, cutoff, n_components = 'GSE94820' , 'tsne', 'std' ,'0.5','250'
...
fig.savefig(outpath + 'results1_new2.png', bbox_inches='tight', dpi = 500)
